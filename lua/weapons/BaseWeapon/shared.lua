...
if CLIENT then
	function SWEP:ResetZoom() self.flZoom = 0 end
	SWEP.flViewModelX = 0
	SWEP.flViewModelY = 0
	SWEP.flViewModelZ = 0
	...
	function SWEP:DoDrawCrosshair() return developer:GetInt() <= 0 && self.bDontDrawCrosshairDuringZoom && LocalPlayer():KeyDown( IN_ZOOM ) end
end
