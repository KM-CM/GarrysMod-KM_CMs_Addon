...
function ENT:Look( MyTable )
	...
	for _, ent in ipairs(
		...
		if !TheirTable.__FLARE_ACTIVE__ && !TheirTable.__ACTOR_BULLSEYE__ && !TheirTable.__PROJECTILE__ && !MyTable.IsHateDisposition( self, ent ) || !MyTable.CanSee( self, ent ) then continue end
